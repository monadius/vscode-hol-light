        ...
        vscodeApi = {
            postMessage: (msg: { command?: string, color?: boolean, margin?: number }) => { 
                if (msg?.command === 'refresh') {
                    ...
                    goalstate = goalstate0;
                    goalstate = createMultipleGoals(goalstate, i % 2 + 1);
