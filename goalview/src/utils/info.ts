...
const queue: Map<string, (text: string) => void> = new Map();
let idCounter = 0;

export function requestConstantInfo(text: string): Promise<string> {
...
export function resolveConstantInfo(id: string, text: string) {
